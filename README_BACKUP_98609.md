...
If your prompt line ends with the `#` character after starting WSL, that means you're signed as root, which is bad. 

Here's how to create a user account manually.

In the following commands, replace `username` with one of your choice. First, run:

```
adduser username --ingroup sudo
```

Input a password and don't bother filling out the other fields. Then, to login in your new account:
...
Additional references: [Microsoft Learn guide](https://learn.microsoft.com/en-us/windows/wsl/setup/environment), [Ubuntu Stack Overflow](https://askubuntu.com/questions/7477/how-can-i-add-a-user-as-a-new-sudoer-using-the-command-line).

> [!NOTE]
> If needed, WSL can be started as root from PowerShell:
>
> ```
> wsl -d distro -u root
> ```
...
>>>>>>> 70e1be11c21acd1998cdcb1e4d0c0cff2ff11743
